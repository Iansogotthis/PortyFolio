...
import './About.css'; // Import a custom CSS file for styling
    ...
    <div className="about-container">
      ...
      <section className="skills-section">
        ...
        <div className="skills-grid">
          ...
          >
            <h3 style={{ color: 'Gray' }}>Front-End Development</h3>
            {hoveredSkill === 'frontEnd' && <p style={{ color: 'black' }}>{skills.frontEnd}</p>}
          </div>
          <div 
            className="skill-item" 
            ...
            onMouseLeave={() => setHoveredSkill(null)}
          >
            <h3 style={{ color: 'Gray' }}>UX/UI Design</h3>
            {hoveredSkill === 'uxUi' && <p style={{ color: 'black' }}>{skills.uxUi}</p>}
          </div>
          <div 
            className="skill-item" 
            ...
            onMouseLeave={() => setHoveredSkill(null)}
          >
            <h3 style={{ color: 'Gray' }}>Back-End Development</h3>
            {hoveredSkill === 'backEnd' && <p style={{ color: 'black' }}>{skills.backEnd}</p>}
          </div>
        </div>
      </section>
